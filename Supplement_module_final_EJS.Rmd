...
load("Routput/lsimsA.RData")
load("Routput/lsimsA-2.RData")
```
...
load("Routput/lsimsB.RData")
load("Routput/lsimsB-2.RData")
```
...
```{r logsims_MC_C}
load("Routput/lsims20.RData")
load("Routput/lsims20-2.RData")
load("Routput/lsims20-3.RData")
load("Routput/lsims20-4.RData")
load("Routput/lsims20-5.RData")
load("Routput/lsims20-6.RData")
load("Routput/lsims20-7.RData")
load("Routput/lsims20-8.RData")
load("Routput/lsims20-9.RData")
load("Routput/lsims20-10.RData")
load("Routput/lsims20-11.RData")
load("Routput/lsims20-12.RData")
load("Routput/lsims20-13.RData")
load("Routput/lsims20-14.RData")
load("Routput/lsims20-15.RData")
load("Routput/lsims20-16.RData")
load("Routput/lsims20-17.RData")
load("Routput/lsims20-18.RData")
load("Routput/lsims20-19.RData")
load("Routput/lsims20-20.RData")
```
...
The distribution of $u$ across bootstrap and Monte Carlo iterates is presented below. Code is included in the accompanying .Rmd file. In the paper we only consider dimensions 1-12 for visual reasons. Here we also include the other 3 components for completeness.
...
\newpage
```{r logCdim15, dependson="logsims_MC_C", echo = FALSE, warning = FALSE, message = FALSE}
ggplot(output_udist_long, 
       aes(x = n, y = dist, lty = estimator)) + 
  ggtitle('Distribution of u (logistic regression)') + 
  labs(x="n", y= "empirical probability") + 
...
\newpage
```{r logCratios15, dependson="logsims_MC_C", echo = FALSE, warning = FALSE, message = FALSE}
ggplot(output_ratios_long, 
  aes(x = n, y = ratio, color = estimator, lty = technique)) + 
  ggtitle('Monte Carlo simulation of ratios (logistic regression)') + 
  labs(x="n", y="ratio of standard errors") + 
...
\newpage
```{r logCratios_nofixedu15, dependson="logsims_MC_C", echo = FALSE, warning = FALSE, message = FALSE}
ggplot(output_ratios_long %>% filter(estimator != "fixedu"), 
       aes(x = n, y = ratio, color = estimator, lty = technique)) + 
  ggtitle('(fixed u excluded)') + 
  labs(x="n", y="ratio of standard errors") + 
...
\newpage
```{r logCratios_nofixedu_and1D15, dependson="logsims_MC_C", echo = FALSE, warning = FALSE, message = FALSE}
ggplot(output_ratios_long %>% filter(!(estimator == "fixedu" & technique == "1D")), 
       aes(x = n, y = ratio, color = estimator, lty = technique)) + 
  ggtitle('(fixed u with 1D algorithm excluded)') + 
  labs(x="n", y="ratio of standard errors") + 
  #geom_smooth(aes(x = n, y = ratio), 
...
load("Routput/psimsB.RData")
load("Routput/psimsB-2.RData")
load("Routput/psimsB-3.RData")
load("Routput/psimsB-4.RData")
```
